# PunkBackup — iPhone Setup, Manual Build (Alternate Method)

> This manual shows the PC app in **English** — go to **"⚙ Settings" →
> "English"** if it isn't already switched (instant, no restart).

**This is the alternate path.** Almost everyone should use the main
**iPhone Setup Manual** instead — it installs a ready-made Shortcut file in
about a minute. Use this guide only if you'd rather build every action by
hand, or want to understand exactly what each step does.

## Before you start, have these ready

Same requirement as the main manual: this system supports several
devices/people (profiles) on the same PC, and **each device needs its own
profile and its own token**.
...
Same as the main manual's automation step — once your hand-built
`PunkBackup` shortcut works, go to the **iPhone Setup Manual**'s "Automate
it: run on its own when you get home" section and follow it exactly the
same way, regardless of how the Shortcut was built.
